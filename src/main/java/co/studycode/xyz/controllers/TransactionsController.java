...
public class TransactionsController {
    ...
    public Transactions creatTransaction( @CurrentUser UserPrinciple userPrinciple ,@Valid @RequestBody TransactionRequest transactionRequest) {
        Transactions transactions = new Transactions();
        transactions.setAmount(transactionRequest.getAmount());
        transactions.setPhone(transactionRequest.getPhone());
        transactions.setUser(userPrinciple.getFullName());
